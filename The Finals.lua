...
local descrtemp = 'Фановый шаблон с разблокированным строиттельством и наймом из города юнитов выше Т1 для тестирования финалок. \n Продаем слитки золота и шары с маной, строим ветки, \n нанимаем отряды в Т5 городе и выходим финалиться! \n Без воров, жезловиков и заклинаний! 1 юнит - 1 малая банка. \n ~by XMCaster
-- ����� ����� (0 - ��� ����������; 1 - � ������������)
local units = 1
